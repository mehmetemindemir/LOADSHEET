...
<%
	...
	prd.updateAllVaryByClassStatus(bagweightId, users.getUserName());
	for(int i=1;i<=recordCount;i++){
		...
		result=prd.createVaryByClassBagWeight(bagweightId, passangerType, class1, class2, class3, class4, class5, class6, class7, users.getUserName(),rowId);
