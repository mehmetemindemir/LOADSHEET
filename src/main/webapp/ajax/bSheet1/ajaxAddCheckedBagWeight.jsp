...
<%
	...
	prd.updateAllCheckedBagWeight(bagweightId, users.getUserName());
	for(int i=1;i<=recordCount;i++){
		...
		bagType			= Helper.request2String(request, "bagType_"+i);
		rowId			= Helper.request2int(request, "rowId_"+i);
		result=prd.createCheckedBagWeight(bagweightId, bagType, class1, class2, class3, class4, class5, class6, class7, users.getUserName(),rowId);
