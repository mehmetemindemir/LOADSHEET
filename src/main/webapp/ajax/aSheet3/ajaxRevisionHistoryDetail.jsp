...
if(Helper.checkAjaxRequest(request)){
	...
	int revisionID=Helper.request2int(request, "revisionID");		
	AhmLoadProcess  prc=new AhmLoadProcess();
	List<UserHistoryData> historyList =prc.getAhmHistory(revisionID);
	int i=1;
%>
<div style="margin: 10px;  overflow: auto;">            
	 <table cellpadding="0" cellspacing="0" width="100%" style="font-size: 12px;" id="historyDetailTable" class="dataTables display" >
	<thead>
		<tr>
